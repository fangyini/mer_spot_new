        ...
        for k_temp in range(start_threshold, 700, 1):
            ...
            for i in test_path:
                ...
                for i in range(num_of_video):
                    ...
                    #N1 = N1 + len([o for o in part if o[-2] == '1'])
                    N2 = N2 + len([o for o in part if o[-2] != '0'])
                ...
                for video_num, pre in enumerate(part_pre):
                    ...
                    video_ann_df = ann_csv[ann_csv.video == video_name]
                    # filter out macro
                    video_ann_df = video_ann_df[video_ann_df.type_idx == 2]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='/Users/adia/Documents/HKUST/projects/phase2/mer_new/mer_spot/outputs/output_V28_micro_system/cas(me)^2')
    ...
    parser.add_argument('--most_pos_num', type=int, default=30)
